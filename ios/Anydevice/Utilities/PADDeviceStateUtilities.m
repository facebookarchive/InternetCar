...
+ (NSString *)messageTitleForCarState:(DeviceState)deviceState {
    NSString *messageTitle;
    switch (deviceState) {
        case DeviceStateOn:
            messageTitle = NSLocalizedString(@"Reverse", nil);
            break;
        case DeviceStateOff:
            messageTitle = NSLocalizedString(@"Drive", nil);
            break;
        case DeviceStateBlink:
            messageTitle = NSLocalizedString(@"Flash Light", nil);
            break;
        default:
            messageTitle = @"";
            break;

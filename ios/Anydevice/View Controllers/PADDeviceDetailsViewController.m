         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // If your device contains a word "car", we will show you control options for internet car(Drive/Reverse/Flash).
    if ([self.deviceNameLabel.text containsString:@"car"]) {
        messageTitle= [PADDeviceStateUtilities messageTitleForCarState:indexPath.row];
    } else {
        messageTitle= [PADDeviceStateUtilities messageTitleForDeviceState:indexPath.row];
    }

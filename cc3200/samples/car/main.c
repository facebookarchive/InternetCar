...
/*
 *   Press SW3 - the device will cycle the LED throu off | on | car state and update its state in the Parse cloud application
 ...
 *                         Notification payload is in the following format: {"alert":"car|on|off"}
 *
 *   http://parse.com
 */
